...
class VectorStore:
    ...
    @staticmethod
    def _mmr_select(results: list, n: int, diversity_penalty: float = 0.4) -> list:
        """
    ...
    def search_memories(self, query: str, persona_id: str = "astra",
        ...
        if mem_results:
            ...
            mem_results = self._mmr_select(mem_results, n=3, diversity_penalty=0.4)
